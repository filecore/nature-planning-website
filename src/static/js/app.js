(function () {
  ...
  const LAYERS = [
    ...
    { id: 'bird-atlas',       file: 'bird-atlas.geojson',       label: 'Bird Atlas (species richness)',    color: '#2563eb', icon: '\u{1F985}', group: 'wildlife' },
    { id: 'butterflies',      file: 'butterflies.geojson',      label: 'Butterflies (NAFI)',               color: '#f97316', icon: '\u{1F98B}', group: 'wildlife' },
    { id: 'bumblebees',       file: 'bumblebees.geojson',       label: 'Bumblebees',                       color: '#ca8a04', icon: '\u{1F41D}', group: 'wildlife' },
    { id: 'wolves',           file: 'wolves.geojson',           label: 'Wolf sightings',                   color: '#7c2d12', icon: '\u{1F43A}', group: 'wildlife' },
    { id: 'bears',            file: 'bears.geojson',            label: 'Bear sightings',                   color: '#78350f', icon: '\u{1F43B}', group: 'wildlife' },
    { id: 'lynx',             file: 'lynx.geojson',             label: 'Lynx sightings',                   color: '#a16207', icon: '\u{1F408}', group: 'wildlife' },
    ...
    { id: 'tick-density',     file: 'tick-density.geojson',     label: 'Tick observation density',         color: '#92400e', icon: '\u{1FAB2}', group: 'wildlife' },
